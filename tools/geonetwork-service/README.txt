...
This service relies on Python 2.5. If Python is uninstalled, this service will not start. 
If Python is upgraded, this service will not start, but can be reinstalled by adding the the install directory of the current Python version to the PATH environment variable and rerunning the install script.
