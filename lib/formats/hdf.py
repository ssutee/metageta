...
class Dataset(__dataset__.Dataset): #Subclass of base Dataset class
    def __init__(self,f):
        ...
        #HDF Imagery types - only ASTER implemented so far
        if hdf_md.has_key('INSTRUMENTSHORTNAME') and hdf_md['INSTRUMENTSHORTNAME']=='ASTER':
            #http://asterweb.jpl.nasa.gov/content/03_data/04_Documents/ASTER_L1_Product_Spec_Ver_1.3_July01.pdf (inc description of GCTP projection parameters)
            #http://lpdaac.usgs.gov/aster/ASTER_GeoRef_FINAL.pdf
            #http://www.science.aster.ersdac.or.jp/en/documnts/users_guide/index.html
            #http://www.science.aster.ersdac.or.jp/en/documnts/pdf/ASTER_Ref_V1.pdf
