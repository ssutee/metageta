...
@see:Format specifications
    ...
    U{http://www.cmar.csiro.au/e-print/open/2008/Pagetmj_a.pdf}
    
    U{http://www-data.wron.csiro.au/rs/MODIS/LPDAAC/MODIS_LandData_readme.txt}

@todo:This is a really dodgy kludge which assumes standard extent coordinates amongst other things purely for DEWHA data supplied by CSIRO. 
